...
//    RealmResults<CakeModel> results;
    ...
    public  void initDagger() {
        ((myapp)getApplication()).getiPresenterComponent().inject(this);
    }
    @Inject
    ...
    @Inject
    public void setCakeListPresenterImplementer(CakeListPresenterImplementer cakeListPresenterImplementer) {
        this.cakeListPresenterImplementer = cakeListPresenterImplementer;
    }
    @Override
