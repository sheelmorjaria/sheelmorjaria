...
public class RockMusicListPresenter_Impl  implements IMusicListPresenter {
        ...
        public RockMusicListPresenter_Impl(Interactor_Impl interactorImpl_) {
                    ...
                    .subscribe(new Consumer<Boolean>() {
                        ...
                        public void accept(@NonNull Boolean isConnectedToInternet) {
                            if (isConnectedToInternet) {
                                ...
                                interactorImpl_.getRockResults()
                                        .observeOn(AndroidSchedulers.mainThread())
